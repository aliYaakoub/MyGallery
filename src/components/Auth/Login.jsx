...
const Login = () => {
    ...
    return (
        <div className={`w-screen text-black transition duration-300 h-screen fixed z-50 bg-black bg-opacity-${bgOpacity} flex flex-col items-center justify-center`}>
            <div style={style} className={`w-96 transition bg-white rounded-lg p-5 relative mx-5`}>
                <Link to='/' className='absolute top-3 right-5 cursor-pointer'>&#10005;</Link>
                <div className='my-5'>
                ...
                <p className='text-center underline cursor-pointer link' onClick={()=>setForgotPassword(true)}>Forgot Password ?</p>
